...
class __TwigTemplate_d674c509514a7b16123dcf97ddf31d44 extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 31
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_user_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 31, $this->source); })()), "id", [], "any", false, false, false, 31)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "admin/user/show.html.twig", "/Applications/MAMP/htdocs/myscoreboard/templates/admin/user/show.html.twig");
    }
}
