...
class __TwigTemplate_280f6df76b686de54d10100cdd7c0a52 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_globalTitle($context, array $blocks = [])
    {
        ...
        echo "Resultats de la recherche pour <code>";
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["jeux"]) || array_key_exists("jeux", $context) ? $context["jeux"] : (function () { throw new RuntimeError('Variable "jeux" does not exist.', 9, $this->source); })()));
        $context['loop'] = [
...
";
    ...
    {
        return array (  161 => 16,  149 => 12,  132 => 10,  115 => 9,  111 => 7,  101 => 6,  80 => 5,  61 => 3,  38 => 1,);
    }
...
{% block globalTitle %}Resultats de la recherche pour <code>{{keyword}}</code>{% endblock %}
{% block body %}
...
{% block footer %}{% endblock %}", "search/index.html.twig", "/Applications/MAMP/htdocs/myscoreboard/templates/search/index.html.twig");
    }
}
