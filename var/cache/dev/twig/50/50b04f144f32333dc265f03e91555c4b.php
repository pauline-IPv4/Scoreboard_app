...
class __TwigTemplate_d8c57f2614ebcf6a5aa4bbcac5f9cba2 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        ";
        // line 9
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 9, $this->source); })()), "pseudo", [], "any", false, false, false, 9), 'row');
        echo "
        ";
        // line 10
...
";
    ...
    {
        return array (  115 => 17,  109 => 14,  105 => 13,  102 => 12,  100 => 10,  96 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "registration/register.html.twig", "/Applications/MAMP/htdocs/myscoreboard/templates/registration/register.html.twig");
    }
}
