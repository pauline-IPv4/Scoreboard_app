...
class __TwigTemplate_df65d8f5b032865a6f4db653933fc201 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["game"]) {
            ...
            // line 28
            echo "   ";
            echo twig_include($this->env, $context, "admin/game/_card.html.twig");
            echo "
    ";
        ...
        if (!$context['_iterated']) {
            // line 30
            echo "        <mark>Aucun resutat trouvé</mark>
    ";
        }
    ...
    <p>Il y a <strong>";
        // line 34
        echo twig_escape_filter($this->env, (isset($context["nb_players"]) || array_key_exists("nb_players", $context) ? $context["nb_players"] : (function () { throw new RuntimeError('Variable "nb_players" does not exist.', 34, $this->source); })()), "html", null, true);
    ...
    ";
        // line 37
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["winners"]) || array_key_exists("winners", $context) ? $context["winners"] : (function () { throw new RuntimeError('Variable "winners" does not exist.', 37, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["winner"]) {
            // line 38
            echo "        <li>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["winner"], "nickname", [], "any", false, false, false, 38), "html", null, true);
            echo "</li>
    ";
        }
        $_parent = $context['_parent'];
...
";
    ...
    {
        return array (  171 => 44,  159 => 40,  150 => 38,  146 => 37,  140 => 34,  136 => 32,  129 => 30,  113 => 28,  111 => 9,  93 => 8,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
...
{% block body %}
    ...
    #}
   {{ include(\"admin/game/_card.html.twig\") }}
    {% else %}
        <mark>Aucun resutat trouvé</mark>
    {% endfor %}
    </div>
